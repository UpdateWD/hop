...
async def information_menu():
	markup = InlineKeyboardMarkup(
		inline_keyboard = [
			[
				InlineKeyboardButton(text = 'Channel', url='https://t.me/+asvFH_IHXmg4MTcy'),
				InlineKeyboardButton(text = 'Chat', url='https://t.me/+STSEEsElV6tmNjli'),
			],
			[
				InlineKeyboardButton(text = 'Checker', url='https://t.me/ftmcheckerbot'),
				InlineKeyboardButton(text = 'Admin', url='https://t.me/fantomcvv'),
			],
			[
				InlineKeyboardButton(text = '🔙', callback_data='back'),
			],
